...
class Thread extends Model
{
    ...
    {
        $this->table = config('laravel-messages.tables.threads');
    ...
    {
        return $this->hasMany(config('laravel-messages.models.message'));
    }
    ...
    {
        return $this->belongsToMany(config('auth.providers.users.model'), config('laravel-messages.tables.participants'),
            'thread_id', 'user_id')
    ...
    public function addParticipants(array $participants)
    {
        if (count($participants)) {
            $participantClass = config('laravel-messages.models.participant');
    ...
    public function scopeTo($query, $users)
    {
        ...
        $participantsTable = config('laravel-messages.tables.participants');
    ...
    {
        $query->whereNotNull(config('laravel-messages.tables.participants') . '.seen_at');
    }
}