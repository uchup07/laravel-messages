...
<ul class="nav nav-pills flex-column nav-stacked">
	<li class="nav-item">
		<a class="nav-link {{ !count(request()->all()) ? 'active' : '' }}"
		   href="{{ route(config('laravel-messages.route.name') . 'message.index') }}">
			Inbox
	...
	<li class="nav-item">
		<a class="nav-link {{ request()->has('sent') ? 'active' : '' }}"
		   href="{{ route(config('laravel-messages.route.name') . 'message.index', ['sent']) }}">
			Sent Mail
		</a>
	</li>
	{{--
	<li class="nav-item">
		<a class="nav-link {{ request()->has('starred') ? 'active' : '' }}"
		   href="{{ route(config('laravel-messages.route.name') . 'message.index', ['starred']) }}">
			Starred
		</a>
	</li>
	<li class="nav-item">
		<a class="nav-link {{ request()->has('drafts') ? 'active' : '' }}"
		   href="{{ route(config('laravel-messages.route.name') . 'message.index', ['drafts']) }}">
			Drafts
