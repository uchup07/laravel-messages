...
<div class="modal fade" id="compose-modal" tabindex="-1">
	<div class="modal-dialog" role="document">
		<form class="modal-content" action="{{ route(config('laravel-messages.route.name') . 'message.store') }}" method="POST">
			@csrf
			...
			<div class="modal-body">
				@include('laravel-messages::form')
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<button type="submit" class="btn btn-primary">@lang('laravel-messages::strings.form.send')</button>
			</div>
		</form>
	</div>
</div>
